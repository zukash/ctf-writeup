...
_sage_const_1024 = Integer(1024); _sage_const_8 = Integer(8); _sage_const_65537 = Integer(65537); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0x1337 = Integer(0x1337); _sage_const_0xDEADBEEF = Integer(0xDEADBEEF); _sage_const_255 = Integer(255); _sage_const_2 = Integer(2)
import os
import random
...
def decrypt(encflag, pq):
    ...
    msg = mat ** d
    return int(msg[_sage_const_0 , _sage_const_1 ] + pow(msg[_sage_const_0 , _sage_const_0 ], _sage_const_0x1337 , n) + _sage_const_0xDEADBEEF ) % n
...
def encrypt(msgint, n):
    ...
    mat = DomainMatrix(
        [
            [Zmodn(a), Zmodn(msgint) - Zmodn(a) ** _sage_const_0x1337  - Zmodn(_sage_const_0xDEADBEEF )],
            [Zmodn(_sage_const_0 ), Zmodn(a)],
        ],
        (_sage_const_2 , _sage_const_2 ),
        Zmodn,
    )
    print(hex(pow(a, _sage_const_0x1337 , n) + _sage_const_0xDEADBEEF ), file=sys.stderr)
