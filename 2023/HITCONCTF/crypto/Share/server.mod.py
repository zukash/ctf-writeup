...
class SecretSharing:
    ...
    def evaluate(self, x: int) -> int:
        print("+++++++++++++++++++++++++++++++++++++++")
        print(x)
        print([self.poly[i] * pow(x, i, self.p) for i in range(len(self.poly))])
        print([self.poly[i] for i in range(len(self.poly))])
        print([pow(x, i, self.p) for i in range(len(self.poly))])
        print(
