...
for bit in tqdm(range(_sage_const_1  << SIZE)):
    ...
    for s in S:
        t *= pow(P[-s - _sage_const_9 ], -_sage_const_1 , q)
        t %= q
    if check(t):
        print("found!")
        print(t)
