...
def encrypt(num_words, secret):
    ...
    assert len(hint.nodes) == len(password)
    print(hint.nodes[0])
    # ex) Node(letter='f', id=67988427)
    print(len(hint.edges))
    print(len(hint.nodes))
    ...
    print("In case you forgot the password, maybe hint.dot will help your memory.")
