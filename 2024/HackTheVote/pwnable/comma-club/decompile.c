...
void *__ptr32 off_325E = (void *__ptr32)0x203E;                        // weak
const char byte_3449[7] = {'\0', '\0', '\0', '\0', '\0', '\0', '\0'};  // idb
...
unsigned __int64 __fastcall simple_vote_printer(__int64 a1) {
  ...
  v6 = 0;
  v4 = (double)*(int *)(a1 + 36) / (double)584057;
  v1 = *(char *)(a1 + 32);
...
unsigned __int64 __fastcall total_vote_printer(__int64 a1) {
  ...
  v4 = 0;
  v2 = (double)*(int *)(a1 + 36) / (double)584057;
  printf("%s\n* Total Votes: %-*.16s *\n* [%*.*s] (%6.2f%%) *\n*%*.0s*\n%s\n",
...
__int64 __fastcall print_status(__int64 a1) {
  ...
  if (*(int *)(a1 + 36) > 584057) {
    printf(
        "Candidate cannot have more votes than the population of Wyoming "
...
__int64 add_votes_menu() {
  ...
  while (1) {
    ...
    if (v1 < (unsigned __int64)num_cands)
      *(_DWORD *)(cand_array + ((__int64)v1 << 6) + 36) += menu(
          "Enter the votes to add\n> ",
          "Too many votes, can't have more than the population of Wyoming\n> ",
          584057);
  }
  return result;
}
